...
public class Words {
    ...
    /*	
     private static List<String> wordsAnswer = new ArrayList<String>();
     private static List<String> wordsWrong = new ArrayList<String>();
     */
    ...
    public Words(String difficulty) {
        ...
        guessWord = new String[word1.length()]; // create the array to be the as long as the number of letters in word
    ...
    public Boolean makeGuess() {
        ...
        for (int i = 0; i < guessWord.length; i++) {
            ...
            if(guessWord[i].equalsIgnoreCase("-")) {
                done = false;
            }
